...
- **전체 설치 가이드**: `MAC_SETUP.md` 참조
- **빠른 참조**: `MAC_QUICK_START.md` 참조
...
1. **Homebrew 사용**: macOS 패키지 관리자로 모든 소프트웨어 설치
2. **Docker Desktop**: 모든 서비스를 한 번에 관리
3. **iTerm2**: 기본 터미널보다 더 나은 개발 경험
4. **터미널 탭**: `Cmd + T`로 새 탭 열어서 백엔드/프론트엔드 분리 실행
